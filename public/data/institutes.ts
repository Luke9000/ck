...
export const PROGRAMS = [
  ...
  },
  {
    ...
    description:
      "формирование визуального языка бренда: от понимания его фундаментальных характеристик до воплощения айдентики на веб-ресурсах с помощью современных цифровых инструментов",
    thesis: "РАЗРАБОТКА САЙТА",
    skills: [
  ...
  },
  {
    ...
    thesis: "РАЗРАБОТКА САЙТА",
    skills: [
      "Основы визуального брендинга для цифровой среды",
      "Технологии визуального представления айдентики",
      "Создание веб-сайта в соответствии с брендбуком",
      "Динамический веб-контент: разработка с использованием JavaScript",
    ],
    videos: ["Promo.mp4", "Kolmykova.mp4"],
    institutes: ["ВШПМ ИМ"],
    previews: [
