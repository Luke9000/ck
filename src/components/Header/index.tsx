...
const index = () => {
  ...
  return (
    <header className="bg-[var(--color-bg)] fixed z-[9] w-full flex-row  items-center no-underline flex h-[13vh] px-8 py-0 left-0 justify-between md:gap-12 xl:gap-30">
      <Link
        href="/"
        className={clsx(
      ...
      <div className="flex flex-row gap-4 align-middle">
        ...
        <Account className="flex justify-center align-middle"></Account>
      </div>
    </header>
  );
};
